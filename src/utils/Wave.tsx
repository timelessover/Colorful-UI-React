...
class Wave extends React.Component<IWaveProps> {
  ...
  private animatingClassName = "cl-react-wave-animation-animating";
  ...
  public animationEnd = () => {
    ...
    this.node.className = cx([this.originClassName]);
    this.node.removeEventListener("animationend", this.animationEnd);
  };
  ...
  public render() {
    ...
    return typeof children === "string" ? (
      <span className="cl-wave-string-wrapper">{children}</span>
    ) : (
      children
    );
  }
