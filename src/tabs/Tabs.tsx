...
import "./style";
import {TabPaneProps,TabsProps, TabsState} from 'types/tabs'



const componentName = "cl-tabs";
...
class Tabs extends React.Component<TabsProps, TabsState> {
      ...
      (child: React.ReactElement<TabPaneProps>) => {
        ...
        return (
          <li
            ...
            className={cx(`${componentName}-title`, {
  ...
  public render() {
    ...
    return (
      <div className={cx(cn, [className], { vertical })} style={style}>
        <ul
          className={cx(`${cn}-head`, { vertical })}
          ref={this.saveHeadRef}
        >
          {this.getTitles()}
          <li
            className={cx(`${cn}-role`, {
              vertical,
              horizontal: !vertical
            })}
